...
plt.title("Рандомный массив + Simple Merge Sort")
...
plt.title("Реверснутый массив + Simple Merge Sort")
plt.xlabel("n размер массива")
plt.ylabel("Время работы в наносекундах")
plt.grid(True)
plt.tight_layout()
...
plt.title("Почти отсортированный массив + Simple Merge Sort")
plt.xlabel("n размер массива")
plt.ylabel("Время работы в наносекундах")
plt.grid(True)
plt.tight_layout()
...
plt.title("Рандомный массив + MergeInsertion Sort")
plt.xlabel("n размер массива")
plt.ylabel("Время работы в наносекундах")
plt.grid(True)
plt.tight_layout()
...
plt.title("Реверснутый массив + MergeInsertion Sort")
plt.xlabel("n размер массива")
plt.ylabel("Время работы в наносекундах")
plt.grid(True)
plt.tight_layout()
...
plt.title("Почти отсортированный массив + MergeInsertion Sort")
plt.xlabel("n размер массива")
plt.ylabel("Время работы в наносекундах")
plt.grid(True)
plt.tight_layout()
